...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: "div", class: "mb-4" do |b|
    ...
    b.optional :readonly
    b.use :label,
          class: "block text-sm font-semibold leading-6 text-gray-900 mb-2",
          error_class: "text-red-500"
    b.use :input,
          class:
            "shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white focus:outline-none focus:ring-0 focus:border-blue-500 leading-6 transition-colors duration-200 ease-in-out",
